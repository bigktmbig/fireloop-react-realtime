...
/**
 * Api services for the `Pbs` model.
 */

export class PbsApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Pbs` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for Pbs registers.
   *
