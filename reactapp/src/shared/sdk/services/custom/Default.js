...
/**
 * Api services for the `Default` model.
 */

export class DefaultApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Default` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for default registers.
   *
