...
/**
 * Api services for the `ServiceTmp` model.
 */

export class ServiceTmpApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `ServiceTmp` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for ServiceTmp registers.
   *
