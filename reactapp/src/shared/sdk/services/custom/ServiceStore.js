...
/**
 * Api services for the `ServiceStore` model.
 */

export class ServiceStoreApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `ServiceStore` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for ServiceStore registers.
   *
