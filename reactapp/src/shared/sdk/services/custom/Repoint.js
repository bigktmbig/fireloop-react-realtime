...
/**
 * Api services for the `Repoint` model.
 */

export class RepointApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Repoint` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for Repoint registers.
   *
