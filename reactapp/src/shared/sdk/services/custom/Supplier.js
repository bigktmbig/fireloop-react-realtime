...
/**
 * Api services for the `Supplier` model.
 */

export class SupplierApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for Supplier registers.
   *
